...
import io.github.mmhelloworld.idris2boot.jvmassembler.AnnotationValue.AnnAnnotation;
import io.github.mmhelloworld.idris2boot.jvmassembler.AnnotationValue.AnnArray;
import io.github.mmhelloworld.idris2boot.jvmassembler.AnnotationValue.AnnBoolean;
import io.github.mmhelloworld.idris2boot.jvmassembler.AnnotationValue.AnnByte;
import io.github.mmhelloworld.idris2boot.jvmassembler.AnnotationValue.AnnChar;
import io.github.mmhelloworld.idris2boot.jvmassembler.AnnotationValue.AnnClass;
import io.github.mmhelloworld.idris2boot.jvmassembler.AnnotationValue.AnnDouble;
import io.github.mmhelloworld.idris2boot.jvmassembler.AnnotationValue.AnnEnum;
import io.github.mmhelloworld.idris2boot.jvmassembler.AnnotationValue.AnnFloat;
import io.github.mmhelloworld.idris2boot.jvmassembler.AnnotationValue.AnnInt;
import io.github.mmhelloworld.idris2boot.jvmassembler.AnnotationValue.AnnLong;
...
public final class Assembler {
    ...
    public void classCodeEnd(String outputClassFileDir) {
        cw.visitEnd();
        if (outputClassFileDir.isEmpty()) {
            interpret();
        } else {
            cws.entrySet().parallelStream()
    ...
    public void createIdrisConstructorClass(String className, boolean isStringConstructor,
        ...
        if (!cws.containsKey(className)) {
            ...
            cw.visit(52, ACC_PUBLIC + ACC_SUPER, className, null, "java/lang/Object",
                new String[]{"io/github/mmhelloworld/idris2boot/runtime/IdrisObject"});
